...
INSERT INTO `Zappiedb`.`Availability` (`Prodct_ID`, `Stor_ID`, `Quantity`) VALUES
(1, 1, 10),
(2, 2, 15),
(3, 3, 20),
(4, 4, 25),
...
(2014, '2024-03-31 00:00:00', '202-04-03 04:00:00', 850, 'Pending', 'T137', 1008, 5, 15),
...
INSERT INTO `zappiedb`.`added_products` (`Cart_ID`, `Prd_ID`, `Quantity`)
